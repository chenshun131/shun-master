package org.cosmos.modules.mapper;
...
/**
 * User: mew <p />
 * Time: 17/11/6 14:27  <p />
 * Version: V1.0  <p />
 * Description:
 * 简单封装fastJSON,完成对象与JSON之间序列化和反序列化的Mapper实现: <p/>
 * <p>
 * 1. 普通序列化 <br/>
 * 2. 带属性过滤序列化 <br/>
 * 3. 带日期格式化 <br/>
 ...
 * <code>
 *
 * @ResponseBody public Resource editForm(@RequestParam String id,HttpServletResponse response) {
