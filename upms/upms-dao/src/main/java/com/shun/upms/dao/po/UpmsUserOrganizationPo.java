package com.shun.upms.dao.po;

import com.shun.framework.persistent.po.GenericLongPo;
import java.io.Serializable;

public class UpmsUserOrganizationPo extends GenericLongPo implements Serializable {
    /** 编号 */
    ...
    public boolean equals(Object that) {
        ...
        UpmsUserOrganizationPo other = (UpmsUserOrganizationPo) that;
