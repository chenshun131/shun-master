...
/**
 * User: mew <p />
 * Time: 17/11/9 16:39  <p />
 * Version: V1.0  <p />
 * Description: 用户controller <p />
 */
@Controller
...
public class UpmsUserController extends BaseController {
    ...
    public String organization(@PathVariable("id") int id, ModelMap modelMap) {
        // 所有组织
        List<UpmsOrganizationPo> upmsOrganizations = upmsOrganizationService.selectByExample(
                new UpmsOrganizationPoExample());
        // 用户拥有组织
        ...
        List<UpmsUserOrganizationPo> upmsUserOrganizations = upmsUserOrganizationService
    ...
    public String role(@PathVariable("id") int id, ModelMap modelMap) {
        // 所有角色
        List<UpmsRolePo> upmsRoles = upmsRoleService.selectByExample(new UpmsRolePoExample());
        // 用户拥有角色
        ...
        List<UpmsUserRolePo> upmsUserRoles = upmsUserRoleService.selectByExample(upmsUserRoleExample);
    ...
    public String permission(@PathVariable("id") int id, ModelMap modelMap) {
        UpmsUserPo user = upmsUserService.selectByPrimaryKey(id);
    ...
    public Object list(@RequestParam(required = false, defaultValue = "0", value = "offset") int offset,
        ...
        List<UpmsUserPo> rows = upmsUserService.selectByExampleForOffsetPage(upmsUserExample, offset, limit);
    ...
    public Object create(UpmsUserPo upmsUser) {
    ...
    @ResponseBody
    public Object update(@PathVariable("id") int id, UpmsUserPo upmsUser) {
        ComplexResult result = FluentValidator.checkAll()
                .on(upmsUser.getUsername(), new LengthValidator(1, 20, "帐号"))
                .on(upmsUser.getRealname(), new NotNullValidator("姓名"))
                .doValidate()
