...
/**
 * User: mew <p />
 * Time: 17/11/9 16:32  <p />
 * Version: V1.0  <p />
 * Description: 角色controller <p />
 */
@Controller
...
public class UpmsRoleController extends BaseController {
    ...
    public String permission(@PathVariable("id") int id, ModelMap modelMap) {
        UpmsRolePo role = upmsRoleService.selectByPrimaryKey(id);
    ...
    public Object list(@RequestParam(required = false, defaultValue = "0", value = "offset") int offset,
        ...
        UpmsRolePoExample upmsRoleExample = new UpmsRolePoExample();
        ...
        List<UpmsRolePo> rows = upmsRoleService.selectByExampleForOffsetPage(upmsRoleExample, offset, limit);
    ...
    public Object create(UpmsRolePo upmsRole) {
    ...
    @ResponseBody
    public Object update(@PathVariable("id") int id, UpmsRolePo upmsRole) {
        ComplexResult result = FluentValidator.checkAll()
                .on(upmsRole.getName(), new LengthValidator(1, 20, "名称"))
                .on(upmsRole.getTitle(), new LengthValidator(1, 20, "标题"))
                .doValidate()
