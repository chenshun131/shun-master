...
<div id="main">
    <div id="toolbar">
        <shiro:hasPermission name="cms:menu:create">
            <a class="waves-effect waves-button" href="javascript:;" onclick="createAction()">
                <i class="zmdi zmdi-plus"></i> 新增菜单
            </a>
        </shiro:hasPermission>
        <shiro:hasPermission name="cms:menu:update">
            <a class="waves-effect waves-button" href="javascript:;" onclick="updateAction()">
                <i class="zmdi zmdi-edit"></i> 编辑菜单
            </a>
        </shiro:hasPermission>
        <shiro:hasPermission name="cms:menu:delete">
            <a class="waves-effect waves-button" href="javascript:;" onclick="deleteAction()">
                <i class="zmdi zmdi-close"></i> 删除菜单
            </a>
        </shiro:hasPermission>
        <shiro:hasPermission name="cms:menu:up">
            <a class="waves-effect waves-button" href="javascript:;" onclick="upAction()">
                <i class="zmdi zmdi-long-arrow-up"></i> 上移菜单
            </a>
        </shiro:hasPermission>
        <shiro:hasPermission name="cms:menu:down">
            <a class="waves-effect waves-button" href="javascript:;" onclick="downAction()">
                <i class="zmdi zmdi-long-arrow-down"></i> 下移菜单
            </a>
        </shiro:hasPermission>
    </div>
