...
<div id="main">
    <div id="toolbar">
        <shiro:hasPermission name="cms:topic:create">
            <a class="waves-effect waves-button" href="javascript:;" onclick="createAction()">
                <i class="zmdi zmdi-plus"></i>新增专题
            </a>
        </shiro:hasPermission>
        <shiro:hasPermission name="cms:topic:update">
            <a class="waves-effect waves-button" href="javascript:;" onclick="updateAction()">
                <i class="zmdi zmdi-edit"></i>编辑专题
            </a>
        </shiro:hasPermission>
        <shiro:hasPermission name="cms:topic:delete">
            <a class="waves-effect waves-button" href="javascript:;" onclick="deleteAction()">
                <i class="zmdi zmdi-close"></i>删除专题
            </a>
        </shiro:hasPermission>
    </div>
