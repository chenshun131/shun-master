...
public class CmsCommentController extends BaseController {
    ...
    public Object list(@RequestParam(required = false, defaultValue = "0", value = "offset") int offset,
        ...
        List<CmsCommentPo> rows = cmsCommentService.selectByExampleWithBLOBsForOffsetPage(cmsCommentExample, offset,
                limit);
    ...
    @ResponseBody
    public Object create(CmsCommentPo cmsComment) {
    ...
    public String update(@PathVariable("id") int id, ModelMap modelMap) {
        CmsCommentPo comment = cmsCommentService.selectByPrimaryKey(id);
    ...
    @ResponseBody
    public Object update(@PathVariable("id") int id, CmsCommentPo cmsComment) {
