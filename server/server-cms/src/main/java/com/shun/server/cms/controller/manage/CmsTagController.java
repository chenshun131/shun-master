...
public class CmsTagController extends BaseController {
    ...
    public Object list(@RequestParam(required = false, defaultValue = "0", value = "offset") int offset,
        ...
        List<CmsTagPo> rows = cmsTagService.selectByExampleForOffsetPage(cmsTagExample, offset, limit);
    ...
    @ResponseBody
    public Object create(CmsTagPo cmsTag) {
    ...
    public String update(@PathVariable("id") int id, ModelMap modelMap) {
        CmsTagPo tag = cmsTagService.selectByPrimaryKey(id);
    ...
    @ResponseBody
    public Object update(@PathVariable("id") int id, CmsTagPo cmsTag) {
        ComplexResult result = FluentValidator.checkAll()
                .on(cmsTag.getName(), new LengthValidator(1, 20, "名称"))
                .doValidate()
                .result(ResultCollectors.toComplex());
